       ...
       <xsl:element name="fileIdentifier">
           ...
           <xsl:element name="language">
               <xsl:element name="LanguageCode">
                   ...
                   <xsl:attribute name="codeListValue"><xsl:value-of select="/gmi:MI_Metadata/gmd:language[1]/gco:CharacterString[1]"/></xsl:attribute>
                   <xsl:attribute name="codeSpace">ISO639-2</xsl:attribute><xsl:value-of select="/gmi:MI_Metadata/gmd:language[1]/gco:CharacterString[1]"/>
               </xsl:element>
           </xsl:element>
           ...
           <xsl:element name="characterSet">
               <xsl:element name="MD_CharacterSetCode">
                   ...
                   <xsl:attribute name="codeListValue"><xsl:value-of select="/gmi:MI_Metadata/gmd:characterSet[1]/gmd:MD_CharacterSetCode[1]/@codeListValue"/></xsl:attribute>
               </xsl:element>
           </xsl:element>
           ...
           <xsl:element name="hierarchyLevel">
               <xsl:element name="MD_ScopeCode">
                   ...
                   <xsl:attribute name="codeListValue"><xsl:value-of select="/gmi:MI_Metadata/gmd:hierarchyLevel[1]/gmd:MD_ScopeCode[1]/@codeListValue"/></xsl:attribute>
